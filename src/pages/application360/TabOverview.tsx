...
const KEY_METRICS = [
  { label: "Uptime (30d)", value: "99.98%", icon: <ShieldCheck className="w-4 h-4" />, color: "text-emerald-500", trend: +0.01 },
  { label: "P99 Latency", value: "42ms", icon: <Zap className="w-4 h-4" />, color: "text-emerald-500", trend: -8 },
  { label: "Error Rate", value: "0.04%", icon: <AlertTriangle className="w-4 h-4" />, color: "text-emerald-500", trend: -0.02 },
  { label: "Throughput", value: "12.4K rpm", icon: <Activity className="w-4 h-4" />, color: "text-blue-500", trend: +11 },
]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="premium-card p-5 flex flex-col items-center justify-center gap-3">
          ...
          <div className="w-full space-y-2 mt-1">
            {[
              { label: "Latency", pct: 96 },
              { label: "Errors", pct: 99 },
              { label: "Infra", pct: 88 },
              { label: "Availability", pct: 99 },
            ].map(d => (
        ...
        <div className="lg:col-span-2 premium-card p-5">
          ...
          <ResponsiveContainer width="100%" height={180}>
            <AreaChart data={HEALTH_SCORE_7D} margin={{ top: 4, right: 0, bottom: 0, left: -20 }}>
              <defs>
